						...
						begin
							...
							try
								...
								begin
									...
									if ls_Rcrd[5] = 'y' then
									cxGridAI_List1.DataController.Values[iRow, 6] := '사용' else cxGridAI_List1.DataController.Values[iRow, 6] := '미사용';
									...
									cxGridAI_List1.DataController.Values[iRow,11] := '사용' else cxGridAI_List1.DataController.Values[iRow,11] := '미사용';
									...
									cxGridAI_List1.DataController.Values[iRow,15] := '요청' else cxGridAI_List1.DataController.Values[iRow,15] := '요청안함';
								end;
							finally
								ls_Rcrd.Free;
