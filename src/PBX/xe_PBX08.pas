...
uses
  ...
  cxGroupBox, cxMemo, cxProgressBar, dxDateRanges, dxSkinOffice2010Silver, dxSkinSharp;
...
procedure Tfrm_PBX08.FormShow(Sender: TObject);
begin
  fSetFont(Frm_PBX08, GS_FONTNAME);
end;
