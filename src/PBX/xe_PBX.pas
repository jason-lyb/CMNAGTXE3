...
uses
  ...
  IdTCPClient, IdHTTP, dxSkinOffice2010Silver, dxDateRanges, cxCustomListBox, dxSkinSharp;
...
type
    ...
    procedure pSetGraphSlide( Var APanel : TPanel; iType, iWH : Integer );
		...
		function func_HoGroup_ID_Search(ATag:integer):Boolean;
...
//    end;
//
//    sTmp := sTmp + '5023                    331          002018-06-12 19:00:002018-06-12 19:30:00001                             001                             5    E'+
//            '[{"GroupID":"001","GroupName":"콜마너1","Hour":"02:00","Date":"2018-06-20","AgentId":"001","AgentName":"홍길동", "Total_cnt":"1","Total_time":"00:00:10","Agent_resp":"10",'+
//            '"Total_in_time":"00:31:14","Total_real_in_time":"00:30:43","In_avg_time":"00:03:25","Agent_resp_20":"10","Agent_resp_20_rate":"100",'+
//            '"Agent_ring_20":"9","Agent_ring_20_rate":"90","Agent_ring_30":"1","Agent_ring_30_rate":"10","Agent_ring_40":"0",'+
//            '"Agent_ring_40_rate":"0","Agent_ring_40_a":"0","Agent_ring_40_a_rate":"0","Total_out_cnt":"23","Total_out_time":"00:05:08","Out_avg_time":"00:00:13"},'+
//            '{"GroupID":"001","GroupName":"콜마너1","Hour":"03:00","Date":"2018-06-21","AgentId":"001","AgentName":"홍길동", "Total_cnt":"1","Total_time":"00:00:10","Agent_resp":"50",'+
//            '"Total_in_time":"00:31:14","Total_real_in_time":"00:30:43","In_avg_time":"00:03:25","Agent_resp_20":"30","Agent_resp_20_rate":"100",'+
//            '"Agent_ring_20":"15","Agent_ring_20_rate":"50","Agent_ring_30":"5","Agent_ring_30_rate":"15","Agent_ring_40":"10",'+
//            '"Agent_ring_40_rate":"25","Agent_ring_40_a":"0","Agent_ring_40_a_rate":"0","Total_out_cnt":"23","Total_out_time":"00:05:08","Out_avg_time":"00:00:13"}]';
//
//    pSI_5455_Recv( sTmp, sPId, bNext);
  finally
...
//    if cxPC_ca.ActivePageIndex = 0 then
//    begin
//      sTmp := '55115023                    331          002018-06-12 19:00:002018-06-12 19:30:00001                             001                             5    E'+
//              '[{"GroupID":"001","GroupName":"콜마너1","AgentId":"001","AgentName":"홍길동", "Total_call":"32","Agent_con_call":"30","Agent_con_call_rate":"100",'+
//              '"Agent_req_call":"0","Agent_req_call_rate":"0","Ivr_cb_from_na_call":"0","Ivr_cb_from_na_call_rate":"0","cb_svc_from_na_call":"0","cb_svc_from_na_call_rate":"0"},'+
//              '{"GroupID":"001","GroupName":"콜마너2","AgentId":"001","AgentName":"이순신", "Total_call":"32","Agent_con_call":"32","Agent_con_call_rate":"100",'+
//              '"Agent_req_call":"0","Agent_req_call_rate":"0","Ivr_cb_from_na_call":"0","Ivr_cb_from_na_call_rate":"0","cb_svc_from_na_call":"0","cb_svc_from_na_call_rate":"0"}]';
//    end else
//    if cxPC_ca.ActivePageIndex = 1 then
//    begin
//      sTmp := '55215023                    331          002018-06-12 19:00:002018-06-12 19:30:00001                             001                             5    E'+
//              '[{"Hour":"10:00","Total_call":"32","Ivr_call":"10","Ivr_call_rate":"10","Agent_Tot_con":"32","Agent_Tot_con_rate":"100","Cti_queue_call":"32","Cti_queue_call_rate":"100",'+
//              '"Cb_svc_from_q_call":"32","Cb_svc_from_q_call_rate":"100","ivr_cb_from_q_call":"32","ivr_cb_from_q_call_rate":"100","Agent_con_call":"32","Agent_con_call_rate":"100",'+
//              '"Agent_req_call":"0","Agent_req_call_rate":"0","Ivr_cb_from_na_call":"0","Ivr_cb_from_na_call_rate":"0","cb_svc_from_na_call":"0","cb_svc_from_na_call_rate":"0","Con_rate":"40"}]';
//    end else
//    if cxPC_ca.ActivePageIndex = 2 then
//    begin
//      sTmp := '55315023                    331          002018-06-12 19:00:002018-06-12 19:30:00001                             001                             5    E'+
//              '[{"Date":"10:00","Total_call":"32","Ivr_call":"10","Ivr_call_rate":"10","Agent_Tot_con":"32","Agent_Tot_con_rate":"100","Cti_queue_call":"32","Cti_queue_call_rate":"100",'+
//              '"Cb_svc_from_q_call":"32","Cb_svc_from_q_call_rate":"100","ivr_cb_from_q_call":"32","ivr_cb_from_q_call_rate":"100","Agent_con_call":"32","Agent_con_call_rate":"100",'+
//              '"Agent_req_call":"0","Agent_req_call_rate":"0","Ivr_cb_from_na_call":"0","Ivr_cb_from_na_call_rate":"0","cb_svc_from_na_call":"0","cb_svc_from_na_call_rate":"0","Con_rate":"40"}]';
//    end;
//
...
//    sTmp := '64115023                    331          003    E'+
//            '[{"Workday":"1","Work_start":"0900","Work_end":"2300","Use_Work":"N", "Breakfast_start":"0001","Breakfast_end":"1111",'+
//            '"Use_Breakfast":"N","Lunch_start":"1300","Lunch_end":"1930","Use_Lunch":"N","Dinner_start":"0000","Dinner_end":"0000",'+
//            '"Use_Dinner":"N","Muser":"홍길동"},{"Workday":"2","Work_start":"0900","Work_end":"2300","Use_Work":"Y",'+
//            '"Breakfast_start":"0001","Breakfast_end":"1111","Use_Breakfast":"N","Lunch_start":"1300","Lunch_end":"1930",'+
//            '"Use_Lunch":"N","Dinner_start":"0000","Dinner_end":"0000","Use_Dinner":"N","Muser":"홍길동"},{"Workday":"3",'+
//            '"Work_start":"0900","Work_end":"2300","Use_Work":"Y", "Breakfast_start":"0001","Breakfast_end":"1111","Use_Breakfast":"N",'+
//            '"Lunch_start":"1300","Lunch_end":"1930","Use_Lunch":"N","Dinner_start":"0000","Dinner_end":"0000","Use_Dinner":"N","Muser":"홍길동"}]';
//
//    pSI_6411_Recv( sTmp, bNext);
  finally
...
//    sTmp := '65115023                    331          003    E'+
//            '[{"Holiday":"2018-06-06","Weekday":"4","Contents":"현충일","Muser":"홍길동"},'+
//            '{"Holiday":"2018-06-13","Weekday":"4","Contents":"6.13지방선거일","Muser":"홍길동"}]';
//
//    pSI_6511_Recv( sTmp, bNext);
  finally
...
//    sTmp := '70515023                    331          003    E'+
//            '[{"IDX":"1","Product":"Basic","Item_Code":"1","Item_Name":"전체착신","USE":"Y","Gubun_1":"09:00","Gubun_2":"20:00","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"2","Product":"Plus","Item_Code":"2","Item_Name":"개별착신","USE":"Y","Gubun_1":"09:00","Gubun_2":"20:00","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"3","Product":"Basic","Item_Code":"2001","Item_Name":"데이터베이스보안","USE":"Y","Gubun_1":"2018-06-25","Gubun_2":"","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"4","Product":"Plus","Item_Code":"2002","Item_Name":"해피문자","USE":"Y","Gubun_1":"09:00","Gubun_2":"20:00","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"5","Product":"Basic","Item_Code":"3","Item_Name":"전체필터링","USE":"Y","Gubun_1":"09:00","Gubun_2":"20:00","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"6","Product":"Plus","Item_Code":"3001","Item_Name":"지능형착신전환","USE":"Y","Gubun_1":"10","Gubun_2":"","Gubun_3":"","Gubun_4":""}'+
//            ',{"IDX":"7","Product":"Basic","Item_Code":"4","Item_Name":"수신거부","USE":"Y","Gubun_1":"09:00","Gubun_2":"20:00","Gubun_3":"","Gubun_4":""}]';
//
//    pSI_7051_Recv( sTmp, bNext);
  finally
...
begin
	...
	begin
//		sStr := fSI_6040_Send(GT_Si415_INFO.Id, Trim(sExten));
...
//    Gauge1.Progress := 0;
//    Gauge1.MaxValue := cxViewFileExcelList.DataController.RowCount;
//    if grpFileUpload.Tag = 1 then  // VIP고객
//    begin
//      for i := 0 to cxViewFileExcelList.DataController.RowCount - 1 do
//      begin
//        sParam :=                cxViewFileExcelList.DataController.Values[i, 1]; // 호분배그룹
//        sParam := sParam + '│' + cxViewFileExcelList.DataController.Values[i, 2]; // 고객전화번호
//        sParam := sParam + '│' + cxViewFileExcelList.DataController.Values[i, 3]; // 고객명
//        sParam := sParam + '│' + cxViewFileExcelList.DataController.Values[i, 4]; // 고객설명
//        sParam := sParam + '│' + cxViewFileExcelList.DataController.Values[i, 5]; // 타입
////        sParam := sParam + '│' + cxViewFileExcelList.DataController.Values[i, 6]; // 사용횟수
//        sParam := sParam + '│' + GT_USERIF.NM;
//
//        pSI_6720_Send(sParam);
//        Gauge1.Progress := i;
...
//      end;
//    end else
//    if grpFileUpload.Tag = 2 then  // 블랙리스트
//    begin
//      for i := 0 to cxViewFileExcelList.DataController.RowCount - 1 do
//      begin
//        sParam :=                cxViewFileExcelList.DataController.Values[i, 1]; // 호분배그룹
...
procedure Tfrm_PBX.FormShow(Sender: TObject);
begin
  fSetFont(Frm_PBX, GS_FONTNAME);
end;
...
function Tfrm_PBX.func_HoGroup_ID_Search(ATag: integer): Boolean;
begin
	SetDebugeWrite('Tfrm_PBX.func_HoGroup_ID_Search');
	try
//		if ATag = 1 then
//		begin
//			bRlt := False;
...
//			slGroupTmp.Clear;
//			sKey := edtGrpNm_qe_s.text; // 조회할 지사명 읽기.
//
////			iOldIdx := cbGrpNm9.ItemIndex;  // 현재 index 값을 저장.[못찾을 경우 현재 선택지사로 되돌려줌]
////			cbGrpNm9.Tag := 99;
//			lst_Group.Items.BeginUpdate;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
////			for i := 0 to cbGrpNm9.Properties.Items.Count - 1 do
////			begin
////
////				if (Pos(sKey, cbGrpNm9.Properties.Items.Strings[i]) > 0) then
////				begin // 지사명  찾기..
////					lst_Group.Items.Add(cbGrpNm9.Properties.Items.Strings[i]);
////					slGroupTmp.Add(inttostr(i));
////					bRlt := True;
////				end;
////			end;
//			lst_Group.Items.EndUpdate;
////			cbGrpNm9.ItemIndex := iOldIdx;
//			lst_Group.Visible := True;
//			lst_Group.Left := 9;
//			lst_Group.Top := 75;
//			if lst_Group.Items.Count > 30 then
//				lst_Group.Height := 500
//			else
//				lst_Group.Height := lst_Group.Items.Count * 18;
////			cbGrpNm9.Tag := 0;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			Result := bRlt;
//		end else
...
//			lst_ID.Items.Clear;
//			slIDTmp.Clear;
//			sKey := edtAgtNm_qe_s.text; // 조회할 지사명 읽기.
//
////			iOldIdx := cbAgtNm9.ItemIndex;  // 현재 index 값을 저장.[못찾을 경우 현재 선택지사로 되돌려줌]
////			cbAgtNm9.Tag := 99;
//			lst_ID.Items.BeginUpdate;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
////			for i := 0 to cbAgtNm9.Properties.Items.Count - 1 do
////			begin
////				if (Pos(sKey, cbAgtNm9.Properties.Items.Strings[i]) > 0) then
////				begin // 지사명  찾기..
////					lst_ID.Items.Add(cbAgtNm9.Properties.Items.Strings[i]);
////					slIDTmp.Add(inttostr(i));
////					bRlt := True;
////				end;
////			end;
//			lst_ID.Items.EndUpdate;
////			cbAgtNm9.ItemIndex := iOldIdx;
//			lst_ID.Visible := True;
//			lst_ID.Left := 226;
//			lst_ID.Top := 75;
//			if lst_ID.Items.Count > 30 then
//				lst_ID.Height := 500
//			else
//				lst_ID.Height := lst_ID.Items.Count * 18;
////			cbAgtNm9.Tag := 0;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			Result := bRlt;
//		end else
...
//		begin
//			bRlt := False;
//			lst_Group10.Items.Clear;
//			slGroupTmp.Clear;
//			sKey := edt_GrpNm10.text; // 조회할 지사명 읽기.
//
//			iOldIdx := cbGrpNm10.ItemIndex;  // 현재 index 값을 저장.[못찾을 경우 현재 선택지사로 되돌려줌]
//			cbGrpNm10.Tag := 99;
//			lst_Group10.Items.BeginUpdate;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			for i := 0 to cbGrpNm10.Properties.Items.Count - 1 do
//			begin
//
//				if (Pos(sKey, cbGrpNm10.Properties.Items.Strings[i]) > 0) then
//				begin // 지사명  찾기..
//					lst_Group10.Items.Add(cbGrpNm10.Properties.Items.Strings[i]);
//					slGroupTmp.Add(inttostr(i));
//					bRlt := True;
//				end;
//			end;
//			lst_Group10.Items.EndUpdate;
//			cbGrpNm10.ItemIndex := iOldIdx;
//			lst_Group10.Visible := True;
//			lst_Group10.Left := 191;
//			lst_Group10.Top := 102;
//			if lst_Group10.Items.Count > 30 then
//				lst_Group10.Height := 500
//			else
//				lst_Group10.Height := lst_Group10.Items.Count * 18;
//			cbGrpNm10.Tag := 0;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			Result := bRlt;
//		end else
...
//		begin
//			bRlt := False;
//			lst_ID10.Items.Clear;
//			slIDTmp.Clear;
//			sKey := edt_AgtNm10.text; // 조회할 지사명 읽기.
//
//			iOldIdx := cbAgtNm10.ItemIndex;  // 현재 index 값을 저장.[못찾을 경우 현재 선택지사로 되돌려줌]
//			cbAgtNm10.Tag := 99;
//			lst_ID10.Items.BeginUpdate;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			for i := 0 to cbAgtNm10.Properties.Items.Count - 1 do
//			begin
//				if (Pos(sKey, cbAgtNm10.Properties.Items.Strings[i]) > 0) then
//				begin // 지사명  찾기..
//					lst_ID10.Items.Add(cbAgtNm10.Properties.Items.Strings[i]);
//					slIDTmp.Add(inttostr(i));
//					bRlt := True;
//				end;
//			end;
//			lst_ID10.Items.EndUpdate;
//			cbAgtNm10.ItemIndex := iOldIdx;
//			lst_ID10.Visible := True;
//			lst_ID10.Left := 408;
//			lst_ID10.Top := 102;
//			if lst_ID10.Items.Count > 30 then
//				lst_ID10.Height := 500
//			else
//				lst_ID10.Height := lst_ID10.Items.Count * 18;
//			cbAgtNm10.Tag := 0;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			Result := bRlt;
//		end else
...
//		begin
//			bRlt := False;
//			lst_Keynumber10.Items.Clear;
//			slIDTmp.Clear;
//			sKey := edt_KeyNumber10.text; // 조회할 지사명 읽기.
//
//			iOldIdx := cbKeynumber10.ItemIndex;  // 현재 index 값을 저장.[못찾을 경우 현재 선택지사로 되돌려줌]
//			cbKeynumber10.Tag := 99;
//			lst_Keynumber10.Items.BeginUpdate;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			for i := 0 to cbKeynumber10.Properties.Items.Count - 1 do
//			begin
//				if (Pos(sKey, cbKeynumber10.Properties.Items.Strings[i]) > 0) then
//				begin // 지사명  찾기..
//					lst_Keynumber10.Items.Add(cbKeynumber10.Properties.Items.Strings[i]);
//					slCallDistTmp.Add(inttostr(i));
//					bRlt := True;
//				end;
//			end;
//			lst_Keynumber10.Items.EndUpdate;
//			cbKeynumber10.ItemIndex := iOldIdx;
//			lst_Keynumber10.Visible := True;
//			lst_Keynumber10.Left := 5;
//			lst_Keynumber10.Top := 102;
//			if lst_Keynumber10.Items.Count > 30 then
//				lst_Keynumber10.Height := 500
//			else
//				lst_Keynumber10.Height := lst_Keynumber10.Items.Count * 18;
//			cbKeynumber10.Tag := 0;
//			// 지사 선택 정보가 변경되면 일부 컨트롤을 초기화 되는 현상을 방지한다.
//			Result := bRlt;
//		end;
    ...
    on e: exception do
    begin
			Log('func_HoGroup_ID_Search Error :' + E.Message, LOGDATAPATHFILE);
			Assert(False, 'func_HoGroup_ID_Search Error :' + E.Message);
		end;
  end;
end;
...
//	cbAgtNm9.ItemIndex := StrToIntDef(slGroupTmp[lst_ID.ItemIndex], 0);
...
//		cbAgtNm9.ItemIndex := StrToIntDef(slIDTmp[lst_ID.ItemIndex], 0);
		lst_ID.Visible := False;
	end else
	if Key = VK_UP then
	begin
...
//    sTmp := '67115023                    331          008888                                                                                                5    E'+
//            '[{"D_Idx":"1","Q_exten":"8888","CallerID":"010-1234-1234","CallerName":"홍길동","CallerDesc":"콜마너테스트","CallerCnt":"5","Call_Type":"1","Muser":"홍길동","U_Time":"2018-06-20 13:33:00"},'+
//            '{"D_Idx":"2","Q_exten":"8888","CallerID":"010-2222-3333","CallerName":"이순신","CallerDesc":"콜마너테스트","CallerCnt":"6","Call_Type":"1","Muser":"홍길동","U_Time":"2018-06-20 13:33:00"}]';
//
//    pSI_6711_Recv( sTmp, bNext);
  finally
...
//    sTmp := '66115023                    331          008888                                                                                                5    E'+
//            '[{"D_Idx":"1","Q_exten":"8888","CallerID":"010-1234-1234","CallerName":"홍길동","CallerDesc":"콜마너테스트","CallerCnt":"5","Call_Type":"2","Muser":"홍길동","U_Time":"2018-06-20 13:33:00"},'+
//            '{"D_Idx":"2","Q_exten":"8888","CallerID":"010-2222-3333","CallerName":"이순신","CallerDesc":"콜마너테스트","CallerCnt":"6","Call_Type":"5","Muser":"홍길동","U_Time":"2018-06-20 13:33:00"}]';

//    pSI_6611_Recv( sTmp, bNext);
  finally
...
//		pSI_6910_Send('6910', '', ''); //호분배그룹, 대표번호 조회
	except
	end;
end;
...
{			sTmp := Format('추가하신 멘트를 리스트에 ', [iCnt]);
			sTmp := sTmp + #13#10 + #13#10 + '[삭제 멘트]';
			sTmp := sTmp + #13#10 + sMentID;
...
//    cxLookupComboBox1.EditValue := 'String';
//    cxLookupComboBox1.Properties.ListColumns[0].ValueTypeClass := TcxStringValueType;
//    cxLookupComboBox1.Properties.ListColumns[1].ValueTypeClass := TcxStringValueType;
//
//    cxLookupComboBox1.Properties.BeginUpdate;
//    try
//      iRow := cxLookupComboBox1.Properties.DataController.AppendRecord;
//
//      cxLookupComboBox1.Properties.DataController.Values[iRow, 0] := 'aaa';
//      cxLookupComboBox1.Properties.DataController.Values[iRow, 1] := 'bbb';
//    finally
//      cxLookupComboBox1.Properties.EndUpdate();
//    end;
