...
uses
  ...
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxLabel, Vcl.ExtCtrls, dxSkinOffice2010Silver, dxSkinSharp;
...
procedure Tfrm_PBX06.FormShow(Sender: TObject);
begin
  fSetFont(Frm_PBX06, GS_FONTNAME);
end;
