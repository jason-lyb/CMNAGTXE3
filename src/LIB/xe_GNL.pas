...
const
  ...
  // 디비 버전과 일치해야 프로그램이 실행됨(cdms_syscode sy_cd = 'CL' dt_value 버전)
	...
	gsClientVer : array[0..0] of AnsiString = ('5C67FCA604AF6B6B6A21DFEE181AF239');  // 4.3.0.223 클라이언트 버전 암호화 처리
  ...
  GS_CDMS_UPFILENAME = 'cmnagtxe3update.exe';
  GS_CDMS_UPFILENAME_NEW = 'cmnagtxe3update_new.exe';
