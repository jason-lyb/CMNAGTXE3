...
//'cmn02                           12345                           27.255.97.16   4    1[{"Q_exten":"9893", "Service_no":"16886618", "Dnis_no":"07045148893", "Buz_name":"콜마너OEM"} ]'
			...
			begin
				...
				Frm_Main.grpPBXLogin.Tag := 1;
				Frm_Main.grpPBXLogin.Visible := False;
...
//			Frm_Main.proc_SI415_AdminLoginSet(sData); //로그인정보 구조체에 저장 - 사용안함
			...
			gSI415_A_Login := True;
			if Frm_Main.grpPBXLogin.Visible then Frm_Main.grpPBXLogin.Visible := False;
	...
	try
		...
		begin
			...
			begin
				...
				if not Frm_Main.grpPBXLogin.Visible then
				begin
		...
		//					Frm_Main.procExecPBX(True,'dCTI_Agent_OEM') ;
						Frm_Main.grpPBXLogin.Left := (Frm_Main.Width  - Frm_Main.grpPBXLogin.Width) div 2;
						Frm_Main.grpPBXLogin.Top  := (Frm_Main.Height - Frm_Main.grpPBXLogin.Height) div 2;
						Frm_Main.grpPBXLogin.Visible := True;
